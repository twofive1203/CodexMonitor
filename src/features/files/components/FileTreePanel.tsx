        ...
        <PanelMeta className="file-tree-meta">
          ...
          {hasFolders ? (
            <button
              ...
              aria-label={allVisibleExpanded ? "收起全部文件夹" : "展开全部文件夹"}
              title={allVisibleExpanded ? "收起全部文件夹" : "展开全部文件夹"}
            >
        ...
        <PanelSearchField
          ...
          trailing={
            <button
              ...
              aria-label={
                filterMode === "modified" ? "显示全部文件" : "只显示已修改文件"
              }
              title={filterMode === "modified" ? "显示全部文件" : "只显示已修改文件"}
            >
