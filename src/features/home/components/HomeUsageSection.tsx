    ...
    <div className="home-usage">
      ...
      {showUsageSkeleton ? (
        ...
        <div className="home-usage-empty">
          ...
          <div className="home-usage-empty-subtitle">运行一个 Codex 会话后，这里会开始统计本地用量。</div>
          {localUsageError && (
        ...
        <>
          ...
          <div className="home-usage-chart-card">
            ...
            <div className="home-usage-chart">
              {chartDays.map((day) => {
                ...
                const tooltip =
                  usageMetric === "tokens"
                    ? `${day.day} · ${formatCount(day.totalTokens)} 令牌`
                    : `${day.day} · ${formatDuration(day.agentTimeMs ?? 0)} 运行时长`;
                return (
          ...
          <div className="home-usage-models">
            <div className="home-usage-models-label">
              常用模型
              {usageMetric === "time" && (
                <span className="home-usage-models-hint">按令牌</span>
              )}
            </div>
