    ...
    >
      ...
      <div className="settings-open-app-footer">
        ...
        <div className="settings-help">
          命令会把选中的路径作为最后一个参数传入。{" "}
          {isMacPlatform()
            ? "应用会通过 `open -a` 启动，并附带可选参数。"
            : "应用会作为可执行程序启动，并附带可选参数。"}
        </div>
      </div>
    </SettingsSection>
  );
