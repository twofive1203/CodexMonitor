  ...
  return (
    ...
    >
      <div className="settings-field">
        ...
        <div className="settings-help">留空则使用系统 PATH 解析结果。</div>
        ...
        <div className="settings-help">
          会在 <code>app-server</code> 前附加这些额外参数。参数值若包含空格，请使用引号。
        </div>
        <div className="settings-help">
          这些设置会应用到所有已连接工作区共享使用的 Codex app-server。
        </div>
        <div className="settings-help">
          会话级覆盖处理会忽略不受支持的参数：<code>-m</code>/<code>--model</code>、
          <code>-a</code>/<code>--ask-for-approval</code>、
