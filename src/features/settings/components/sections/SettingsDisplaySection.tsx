    ...
    >
      ...
      <div className="settings-field">
        ...
        <div className="settings-help">
          数值越大，保留的历史越多，但也可能增加内存占用。可在会话中使用“从服务端同步”重新获取更早的消息。
        </div>
      </div>
      <div className="settings-field">
      ...
      <SettingsToggleRow
        title="通知音效"
        subtitle="当窗口未聚焦且长时间运行的智能体完成时播放提示音。"
      >
        <SettingsToggleSwitch
      ...
      <SettingsToggleRow
        title="系统通知"
        subtitle="当窗口未聚焦且长时间运行的智能体完成时显示系统通知。"
      >
        <SettingsToggleSwitch
